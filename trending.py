...
def fetch_and_save_tiktok_data(count=30, region='CA', priority_region='CA', language='pt', sys_region='CA'):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("Error fetching data from TikTok API. Status Code:",
...
def fetch_and_save_tiktok_data_method2(count=30, region='US', priority_region='TW', language='en'):
